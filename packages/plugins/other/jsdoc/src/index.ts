import { PluginFunction } from '@fevo-tech/graphql-codegen-plugin-helpers';
import {
  printSchema,
  parse,
  visit,
...
import { DEFAULT_SCALARS, RawDocumentsConfig } from '@fevo-tech/graphql-codegen-visitor-plugin-common';
